...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void getData(){
    sharedPresenter.getInterest().then((value) {
      interestList.add(InterestListModel(id: "Select Sport",image: "",imageName: "",name: "Select Sport"));
      interestList1.add(InterestListModel(id: "Select Sport",image: "",imageName: "",name: "Select Sport"));
      interestList2.add(InterestListModel(id: "Select Sport",image: "",imageName: "",name: "Select Sport"));
      interestList3.add(InterestListModel(id: "Select Sport",image: "",imageName: "",name: "Select Sport"));
                 ...
                 Container(
                   ...
                   child: Column(
                     children: [
                       ...
                       Container(
                         // group2nME (14:4)
                         margin: EdgeInsets.fromLTRB(10*fem, 0*fem, 10*fem, 15*fem),
                         width: double.infinity,
                         height: 60*fem,
                         decoration: BoxDecoration (
                       ...
                       Container(
                         margin: EdgeInsets.fromLTRB(10*fem, 0*fem, 10*fem, 25*fem),
                         width: double.infinity,
                         height: 60*fem,
                         decoration: BoxDecoration (
                           borderRadius: BorderRadius.circular(5*fem),
                       ...
                       Row(
                         ...
                         children: [
                            interestList1.length>0? Container(
                             ...
                             child: DropdownButton<String>(
                               ...
                               onChanged: (String? newValue) {
                                 setState(() {
                                   ...
                                   interestList2.removeWhere((item) => item.id == dropdownValue1);
                                   interestList3.removeWhere((item) => item.id == dropdownValue1);
                                 });
                               },
                             )):SizedBox(),
                           SizedBox(width: 40,),
                           interestList2.length>0? Container(
                               ...
                               child: DropdownButton<String>(
                                 ...
                                 onChanged: (String? newValue) {
                                   setState(() {
                                     ...
                                     interestList1.removeWhere((item) => item.id == dropdownValue2);
                                     interestList3.removeWhere((item) => item.id == dropdownValue2);
                                   });
                                 },
                               )):SizedBox(),
                       ...
                       Container(
                         ...
                         Row(
                           mainAxisAlignment: MainAxisAlignment.start,
                           children: [
                             interestList3.length>0? Container(
                                 margin: EdgeInsets.only(left: 10,bottom: 10),
                                 padding: EdgeInsets.all(6),
                                 decoration: BoxDecoration (
                                     borderRadius: BorderRadius.circular(5*fem),
                                 ...
                                 child: DropdownButton<String>(
                                   ...
                                   onChanged: (String? newValue) {
                                     setState(() {
                                       ...
                                       interestList1.removeWhere((item) => item.id == dropdownValue3);
                                       interestList2.removeWhere((item) => item.id == dropdownValue3);
                                     });
                                   },
                                 )):SizedBox(),
                             SizedBox(width: 40,),
                       ...
                       TextButton(
                         onPressed: () {
                           if(userNameController.text.isEmpty){
                             ...
                             AppLocalDataUtil().getMobile().then((value){
                               RegisterModel registerModel= RegisterModel();
                               registerModel.emailId=emailController.text;
                               registerModel.phoneNumber=value;
                               registerModel.firstName=fullNameController.text.toString();
                               registerModel.lastName=userNameController.text.toString();
                               registerModel.dob=df.format(_selectedDate!);
                               registerModel.gender=selected==Gender.Male?"Male":"Female";
                               registerModel.joinFor="Participants";
                               registerModel.primaryInetrestId=dropdownValue1;
                               registerModel.secondaryInetrestId=dropdownValue2;
                               registerModel.thirdInetrestId=dropdownValue3=="Select Sport"?"":dropdownValue3;

                               print(registerModel.toJson());
                               _authPresenter.registerUser(registerModel).then((value) {
                                 if(value) {
                                   showCustomSnackBar( "Register Successfully",context,isError: false);
