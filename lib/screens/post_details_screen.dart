...
class PostDetailsScreen extends StatefulWidget {
  PostDetailsScreen(this.postModelData,);
        ...
        child: Column(
          ...
          children: [
            Opacity(
              opacity: 0.99,
              child: Container(
                margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 22.85*fem),
                child: TextButton(
                  onPressed: () {},
                  ...
                  child: Container(
                    padding: EdgeInsets.fromLTRB(25*fem, 28*fem, 28*fem, 15*fem),
                    width: double.infinity,
                    height: 76*fem,
                    decoration: BoxDecoration (
            ...
            Container(
              margin: EdgeInsets.fromLTRB(11*fem, 0*fem, 12*fem, 79*fem),
              width: double.infinity,
              height: 600*fem,
              decoration: BoxDecoration (
            ...
            Align(alignment: Alignment.center, child:Text(widget.postModelData.desc.toString(),style: TextStyle(color: Colors.black),)),
                      ...
                      children:  [
                        GestureDetector(
                            ...
                            child: Container(child: Row(children: [
                              ...
                              SizedBox(width: 5,),
                              Text(widget.postModelData.likeCount.toString(),style: TextStyle(color: Colors.grey),)
                        ...
                        GestureDetector(
                          ...
                          child: Container(child: Row(children: [
                            ...
                            SizedBox(width: 5,),
                            Text(widget.postModelData.commentCount.toString(),style: TextStyle(color: Colors.grey),)
                          ],),),),
                  ...
                  Padding(padding: EdgeInsets.all(5),
                    child:Align(alignment: Alignment.topLeft,child:Text(widget.postModelData.desc.toString(),
                  style: SafeGoogleFont (
                    'Lato',
                    fontSize: 12*ffem,
                    fontWeight: FontWeight.w400,
