...
class FollowingListContent extends StatefulWidget {
  @override
  _FollowingListContentState createState() => _FollowingListContentState();
}

class _FollowingListContentState extends State<FollowingListContent> {
  @override
          ...
          children: [
           ...
           /* ListView.builder(itemCount: 5,
              ...
              itemBuilder: (context, i) {
                return UserWidgetItem(allUser.elementAt(i),"unFollow");
              },)*/
          ],
        ),
      ),
